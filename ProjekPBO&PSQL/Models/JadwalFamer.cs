...
namespace ProjekPBO_PSQL.Models
{
    class JadwalFarmer : Jadwal
    {
        ...
        public JadwalFarmer(int idJadwal, DateTime tanggal, string keteranganKegiatan, int banyakAnggota, List<int> iDAnggota, List<string> namaAnggota, string status, string namaLahan, string namaTanaman, DateTime tanggalDitanam, int jumlahDitanam) : base (idJadwal, tanggal, keteranganKegiatan, "Farmer", banyakAnggota, iDAnggota, namaAnggota, status)
        {
